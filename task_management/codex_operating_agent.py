    ...
    def _prompt(
        ...
        *,
        ...
        return (
            ...
            + "For completion/progress/deferral/confirmation/correction/workflow-restructure feedback, emit proposal_patches rather than new tasks. "
            ...
            + "semantic_update_type=completion|progress|deferral|confirmation|correction|workflow_restructure as applicable. "
            ...
            + "For an explicit existing-workflow structure change, target the current parent and set "
            + "semantic_update_type=workflow_restructure. Use relation_action=detach_children and child_proposal_ids=<exact comma-separated ids> "
            + "to make direct leaf children standalone. Set status=done only when the old parent should also be completed. "
            + "Ask clarification instead of approximating reparenting or nested-workflow moves.\n"
        ...
        "direct_responses": {
            ...
            "items": {
                ...
                "properties": {
                    ...
                    "response_type": {
                        "type": "string",
                        "enum": ["answer", "explanation", "status_summary"],
                    },
                    "proposal_id": {"type": "string"},
                    "request_id": {"type": "string"},
